...
import Img1 from '../../assets/paraColorearElReinoDeLosCielos/Bautismo-de-Jesus.jpg';
import Img2 from '../../assets/paraColorearElReinoDeLosCielos/Dejenque-los-ninos-vengan-a-mi.jpg';
import Img3 from '../../assets/paraColorearElReinoDeLosCielos/Jesus-y-los-ninos-2.gif';
import Img4 from '../../assets/paraColorearElReinoDeLosCielos/Jesus-y-los-ninos.jpg';
import Img5 from '../../assets/paraColorearElReinoDeLosCielos/Los-ninos-de-Jesus.jpg';
import Img6 from '../../assets/paraColorearElReinoDeLosCielos/Los-ninos-y-el-reino.jpg';
import Img7 from '../../assets/paraColorearElReinoDeLosCielos/Permanece-con-Jesus.jpg';
import Img8 from '../../assets/paraColorearElReinoDeLosCielos/Reino-de-los-cielos.jpg';
...
export default function ParaColorearElReinoDeLosCielos() {
    const images = [
        ...
        <div className="content-page-armadura">
          <div className="content-home" style={{ margin: 'auto', justifyContent: 'center' }}>
            <h3 style={{ fontSize: '1em', color: '#b57917' }}>
              <LetrasGlobo texto={`Imagenes para colorear el reino de los cielos`} />
            </h3>
          </div>
          <div style={{ width: '100%' }}>
