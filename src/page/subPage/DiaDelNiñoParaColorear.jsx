...
import Img3 from '../../assets/diaDelNiñoParaImprimir/Dia-del-Nino-2.jpg';
import Img4 from '../../assets/diaDelNiñoParaImprimir/Dia-del-Nino-2.png';
import Img5 from '../../assets/diaDelNiñoParaImprimir/Dia-del-Nino-3.jpg';
import Img6 from '../../assets/diaDelNiñoParaImprimir/Dia-del-Nino-4.jpg';
import Img7 from '../../assets/diaDelNiñoParaImprimir/Dia-del-Nino-5.jpg';
import Img8 from '../../assets/diaDelNiñoParaImprimir/Dia-del-Nino-6.jpg';
...
export default function DiaDelNiñoParaColorear() {
    const images = [
        ...
        <div className="content-page-armadura">
          <div className="content-home" style={{ margin: 'auto', justifyContent: 'center' }}>
            <h3 style={{ fontSize: '1em', color: '#b57917' }}>
              <LetrasGlobo texto={`Imagenes del dia del nino para imprimir`} />
            </h3>
          </div>
          <div style={{ width: '100%' }}>
