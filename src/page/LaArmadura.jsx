        ...
        <div className="Home">
            ...
            <div className="page-container">
                ...
                <div style={{display:'flex', margin: 'auto', justifyContent: 'center', flexWrap: 'wrap', gap: '20px'}}>
                    ...
                    <iframe className="button-nav" width="200" height="220" src="https://www.youtube.com/embed/RK55zFKMH8k?si=B2rA0iEmwWWaVw9n" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
                <div className="content-page-armadura">
                    ...
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> 1 Pedro 5:8:</strong> Sean prudentes y manténganse despiertos, <strong style={{color: 'red'}}>porque su enemigo el diablo, como un león rugiente, anda buscando a quien devorar.</strong><sup> 9</sup> resístanle, firmes en la fe, sabiendo que en todas partes del mundo los hermanos de ustedes están sufriendo las mismas cosas.
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> JESUS les dijo en: Juan 8: 44:</strong><strong style={{color: 'red'}}> El padre de ustedes es el diablo;</strong> ustedes le pertenecen, y tratan de hacer lo que él quiere. <strong style={{color: 'red'}}>El diablo ha sido un asesino desde el principio.</strong> No se mantiene en la verdad, y nunca dice la verdad. Cuando dice mentiras, habla como lo que es; porque es mentiroso y es el padre de la mentira.
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> 1 Juan 5:  19:</strong> Sabemos que somos de Dios y que el mundo entero <strong style={{color: 'red'}}>está bajo el poder del maligno.</strong>
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> 2 Corintios 2: 11:</strong> Así <strong style={{color: 'red'}}>Satanás</strong> no se aprovechará de nosotros, pues conocemos muy bien sus malas intenciones.
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> 1 Timoteo 5: 14:</strong> Quiero, pues, que las viudas jóvenes se casen, críen hijos, gobiernen su casa; <strong style={{color: 'red'}}>que no den al adversario ninguna ocasión de maledicencia.</strong>
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Mateo 24:24:</strong> <strong style={{color: 'red'}}>Porque vendrán falsos mesías y falsos profetas;</strong> y harán grandes señales y milagros, para engañar, a ser posible, hasta a los que Dios mismo ha escogido.
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Lucas 22: 3:</strong> <strong style={{color: 'red'}}>Entonces Satanás entró en Judas</strong>, uno de los doce discípulos, al que llamaban Iscariote.
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> 2 de Corintios 11: 14:</strong> Y esto no es nada raro, <strong style={{color: 'red'}}>ya que Satanás mismo se disfraza de ángel de luz;</strong> 15 por eso resulta muy natural que sus servidores pretendan aparecer como defensores de la justicia. ¡Pero habrán de terminar como sus hechos merecen!
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Lucas 11: 14:</strong> Jesús estaba <strong style={{color: 'red'}}>expulsando un demonio</strong> que había dejado mudo a un hombre; y cuando <strong style={{color: 'red'}}>el demonio salió</strong>, el mudo comenzó a hablar. La gente se admiró de esto
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Marcos 1: 34:</strong> Jesús sanó de toda clase de enfermedades a mucha gente, y <strong style={{color: 'red'}}>expulsó a muchos demonios</strong>; pero no dejaba que los <strong style={{color: 'red'}}>demonios hablaran</strong>, porque ellos lo conocían.
                    </div>
                        <div>
                    <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Mateo 8: 31:</strong> y <strong style={{color: 'red'}}>los demonios le rogaron</strong> a Jesús: —<strong style={{color: 'red'}}>Si nos expulsas</strong>, déjanos entrar en esos cerdos.
                        </div>
                    <div>
                    <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Lucas 11: 20:</strong> Porque <strong style={{color: 'red'}}>si yo expulso los demonios</strong> por la mano de Dios, eso significa que el reino de Dios ya ha llegado.
                        </div>
                    <div>                    
                        Jesucristo vino a protegernos de los demonios y a sanar enfermedades lo demostró sacándole demonios y sanando de enfermedades muchas personas. En el ejército, todo soldado que va a la guerra es equipado con las armas necesarias para la batalla contra el enemigo y garantizar así la victoria.  Si esto se hace es una guerra terrenal ¿Cuánto más en la lucha del cristiano contra las huestes espirituales de maldad que atacan al reino de Dios?. Todo creyente que libra una batalla espiritual, no debe de salir a luchar con armas terrenales, cualquier arma que se use contra los poderes del maligno debe de ser espiritual. Otra clase de armas es imperante e inútil. En el siguiente versículo se corrobora
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Hechos 19: 15:</strong> Pero en cierta ocasión <strong style={{color: 'red'}}>el espíritu maligno</strong> les contestó: «Conozco a Jesús, y sé quién es Pablo; pero ustedes, ¿quiénes son?»16 Al mismo tiempo, <strong style={{color: 'red'}}>el hombre que tenía el espíritu maligno se lanzó sobre ellos</strong>, y con gran fuerza los dominó a todos, maltratándolos con tanta violencia que huyeron de la casa desnudos y heridos. (Nota: «sólo obedecen a los que viven en Santidad “)
                    </div>
                    <div>
                    ...
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Romanos 12: 21:</strong> No te dejes vencer por el mal. Al contrario, vence con el bien el mal.
                    </div>
                    <div>
                    ...
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Job 2: 4:</strong><strong style={{color: 'red'}}> Pero el acusador</strong> contestó al Señor: —Mientras no lo tocan a uno en su propio pellejo, todo va bien. El hombre está dispuesto a sacrificarlo todo por salvar su vida. 5 Pero tócalo en su propia persona y verás cómo te maldice en tu propia cara.  (Nota 1º con una sarna en la piel y 2º con sus bienes y familia)
                    </div>
                    <div>
                        6 El Señor respondió <strong style={{color: 'red'}}>al acusador</strong>: —Está bien, haz con él lo que quieras, con tal de que respetes su vida. (Job venció porque permaneció al lado de Dios)
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Lucas 22:31:</strong> Jesús anuncia que Pedro lo negará 31 Dijo también el Señor: —Simón, Simón, <strong style={{color: 'red'}}>mira que Satanás los ha pedido a ustedes para sacudirlos como si fueran trigo</strong>;
                    </div>
                    <div>
                        Dios me libertó de varias adicciones y tuve muchas pruebas y las vencí. La más difícil de vencer fue los celos con mi esposa (porque el ladrón juzga por su condición). También los <strong style={{color: 'red'}}>demonios me tiraban dardos de desconfianza</strong>, pero todo esto lo vencí en el poder del Espíritu Santo.  Pero si uno después de ser liberado voluntariamente planea el pecado, el fin es mucho peor.  Esto se corrobora en:
                    </div>
                    <div>
                    ...
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Efesios 6: 10:</strong> Y ahora, hermanos, busquen su fuerza en el Señor, en su poder irresistible. 11 Protéjanse con toda la armadura que Dios les ha dado, <strong style={{color: 'red'}}>para que puedan estar firmes contra los engaños del diablo</strong>. 12 Porque no estamos luchando contra poderes humanos, sino contra malignas fuerzas espirituales del cielo, <strong style={{color: 'red'}}>las cuales tienen mando, autoridad y dominio sobre el mundo de tinieblas que nos rodea</strong>. 13 Por eso, tomen toda la armadura que Dios les ha dado, para que puedan resistir en el día malo y, después de haberse preparado bien, mantenerse firmes.
                    </div>
                    <div>
                        14 Así que manténganse firmes, revestidos de la verdad y protegidos por la rectitud. 15 Estén siempre listos para salir a anunciar el mensaje de la paz. 16 Sobre todo, que su fe sea el escudo que los libre de las flechas encendidas del maligno.
                    </div>
                    <div>
                        JESUCRISTO vino a demostrar que somos oprimidos por el mal.   Los demonios toman posesión de las personas que practican el pecado.  Yo lo experimenté; desde niño planeaba la maldad  (lo refiero en mi testimonio), terminé adicto a varias drogas, a la inmundicia sexual, amor al  dinero.  A esto, los psicólogos lo llamas adición y dependencia.  Ya no  podía controlar mi temperamento agresivo pero logré salir unido a CRISTO de muchas adiciones con oración y ayuno.  Fue  una transformación integral sin internarme. DIOS rompió las cadenas y hoy quiero compartir mi experiencia para que podamos ayudar al prójimo. Esto se confirma en:
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Lucas 8:2:</strong> ,   como también algunas mujeres que él había curado de espíritus malignos y enfermedades. Entre ellas iba María, la llamada Magdalena, de la que <strong style={{color: 'red'}}>habían salido siete demonios</strong>;
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> 1 Juan 3: 8:</strong> pero <strong style={{color: 'red'}}>el que practica el pecado es del diablo</strong>, porque el diablo peca desde el principio. Precisamente para esto ha venido el Hijo de Dios: para deshacer lo hecho por el diablo. (nota: practicar el pecado = adición y dependencia)
                    </div>
                    <div style={{margin:'auto', textAlign:'center', fontSize: '1.3em', fontWeight: 'bold', color:'#fbbf62'}}>
                        Las posiciones demoniacas más comunes son:
                    </div>
                    <div>
                        <strong style={{color: 'red'}}>1º La inmundicia sexual</strong>, tiene que ver con el:  adulterio, la fornicación, el homosexualismo, lesbianismo, webcam, las orgias, la pornografía, aquí se cultivan los pederastas l, homicidas y otros  comportamientos que solo con liberación los controlan, y causan condenación eterna. Confirma en:
                    </div>
                    <div>
                    ...
                    <div>
                        Paso Nº 2. Quien hace la oración de liberación debe ser honesto y llamar las cosas por su nombre.
                    </div>
                    <div>
                    ...
                    <div>
                        Paso Nº 5.  El «liberado» debe arrepentirse de todos los pecados. Sin arrepentimiento no hay liberación, se debe confesar y apartarse del pecado. DIOS está enterado de todo pecado pero nos Ama.
                    </div>
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> Proverbios 28: 13:</strong> Al que disimula el pecado, no le irá bien; pero el que lo confiesa y lo deja, será perdonado.
                    </div>
                    <div>
                        Paso Nº 6. El «liberado» debe romper con el ocultismo, las maldiciones, y la masonería que es de donde vienen los problemas demoniacos más horribles y van de generación en generación. Dios Habla Hoy Efesios 5: 11 No compartan la conducta estéril de los que <strong style={{color: 'red'}}>son de la oscuridad</strong>; más bien sáquenla a la luz.
                    </div>
                    <div>
                        Paso Nº 7. El «liberado» debe perdonar a los que le han ofendido de todo corazón, Jesús dijo en Marcos 11: 25 Y cuando estén orando, perdonen lo que tengan contra otro, para que también su Padre que está en el cielo les perdone a ustedes sus pecados.
                    </div>
                    <div>
                        A los hijos de Dios, JESUCRISTO les ha dado poder para expulsar demonios.   Esto se logra cuando en el nombre de JESUCRISTO le ordenamos al demonio salir fuera; en ese momento quien está siendo liberado generalmente llora, vomita, tose o sopla.
                    </div>
                    <div style={{margin:'auto', textAlign:'center', fontSize: '1.3em', fontWeight: 'bold', color:'#fbbf62'}}>
                    ...
                    <div>
                        <strong style={{color: '#fbbf62'}}>Dios Habla Hoy</strong><strong style={{color: '#63ca18'}}> 1 Juan 2: 13:</strong> Padres, les escribo a ustedes porque han conocido al que ya existía desde el principio. Jóvenes, les escribo a ustedes <strong style={{color: 'red'}}>porque han vencido al maligno</strong>.14 Les he escrito a ustedes, hijitos, porque han conocido al Padre. Les he escrito a ustedes, padres, porque han conocido al que ya existía desde el principio. Les he escrito también a ustedes, jóvenes, porque son fuertes y han aceptado la palabra de Dios en su corazón, <strong style={{color: 'red'}}>y porque han vencido al maligno</strong>.
                    </div>
                    <div>
